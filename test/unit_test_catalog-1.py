...
def test_create_table_1():
    ...
    t = cat.create_table(
        "people",
        "/Users/TedMoskovitz/Columbia/Fall_2018/W4111-f18/Projects/HW3/data/People.csv")
...
def test_create_table_4():
    ...
    t = cat.create_table("batting",
                         "/Users/TedMoskovitz/Columbia/Fall_2018/W4111-f18/Projects/HW3/data/Batting.csv",
                         cds)
